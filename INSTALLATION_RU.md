...
Поддерживаемые типы блоков: Приветствие, Тестирование прототипа, Открытые вопросы, Один/Несколько из списка, Шкала, Карточная сортировка, Древовидное тестирование, Завершение.
